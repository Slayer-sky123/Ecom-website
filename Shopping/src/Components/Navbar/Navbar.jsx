...
const Navbar = () => {
    ...
    return (
        <>
            <nav className="bg-white fixed top-0 z-[999] w-full">
                <div className="px-4 md:px-10">
                    <div className="flex items-center justify-between h-20">
                        <div className="flex items-center w-full justify-between">
                            <Link to="/" className="flex-shrink-0 flex items-end gap-2">
                                <img className="w-32 h-6" src={logoImg} alt="Workflow" />
                            </Link>
                            ...
                            <div className='hidden md:block'>
                                <div className='flex items-center justify-start gap-8'>
                                    <Link to="/login"><svg width="25" height="25" viewBox="0 0 28 28" fill="black" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <Link><svg width="25" height="25" viewBox="0 0 28 28" fill="white" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <Link to="/cart"><svg width="25" height="25" viewBox="0 0 28 28" fill="black" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex items-center gap-4 md:gap-6 md:hidden">
                            <button onClick={setToggle} className="text-gray-800 dark:text-white hover:text-gray-300 inline-flex items-center justify-center p-2 rounded-md focus:outline-none">
                                <svg width="20" height="20" fill="#b88e2f" className="w-8 h-8" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
